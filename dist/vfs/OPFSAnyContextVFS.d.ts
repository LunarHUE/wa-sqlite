...
declare const OPFSAnyContextVFS_base: {
...
export declare class OPFSAnyContextVFS extends OPFSAnyContextVFS_base {
    mapIdToFile: Map<number, File>;
    lastError: any;
    log: any;
    static create(name: string, module: any, options?: any): Promise<OPFSAnyContextVFS>;
    ...
    jTruncate(fileId: number, iSize: number): Promise<number>;
