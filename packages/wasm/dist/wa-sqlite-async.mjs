...
function findWasmBinary() {
  ...
  // Use bundler-friendly `new URL(..., undefined)` pattern; works in browsers too.
  return new URL('wa-sqlite-async.wasm', undefined).href;
...
function assignWasmExports(wasmExports) {
  ...
  _RegisterExtensionFunctions = Module['_RegisterExtensionFunctions'] = wasmExports['RegisterExtensionFunctions'];
  _getSqliteFree = Module['_getSqliteFree'] = wasmExports['getSqliteFree'];
  _main = Module['_main'] = wasmExports['main'];
  _libauthorizer_set_authorizer = Module['_libauthorizer_set_authorizer'] = wasmExports['libauthorizer_set_authorizer'];
  _libfunction_create_function = Module['_libfunction_create_function'] = wasmExports['libfunction_create_function'];
  _libhook_commit_hook = Module['_libhook_commit_hook'] = wasmExports['libhook_commit_hook'];
  _libhook_update_hook = Module['_libhook_update_hook'] = wasmExports['libhook_update_hook'];
  _libprogress_progress_handler = Module['_libprogress_progress_handler'] = wasmExports['libprogress_progress_handler'];
  _libvfs_vfs_register = Module['_libvfs_vfs_register'] = wasmExports['libvfs_vfs_register'];
...
})();// end include: src/libauthorizer.js

// include: src/libfunction.js
// Copyright 2024 Roy T. Hashimoto. All Rights Reserved.
// This file should be included in the build with --post-js.
...
})();// end include: src/libfunction.js

// include: src/libhook.js
// Copyright 2024 Roy T. Hashimoto. All Rights Reserved.
// This file should be included in the build with --post-js.
...
// end include: src/libhook.js

// include: src/libprogress.js
// Copyright 2024 Roy T. Hashimoto. All Rights Reserved.
// This file should be included in the build with --post-js.
...
})();// end include: src/libprogress.js

// include: src/libvfs.js
// Copyright 2024 Roy T. Hashimoto. All Rights Reserved.
// This file should be included in the build with --post-js.
